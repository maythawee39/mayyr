...
if(isset($_GET['get_json'])){
	...
	foreach($get_calendar as $calendar){
		...
		$json[] = array(
			...
			'booking_by'=>$calendar['booking_by'],
			'department'=>$calendar['department'],
			'meeting_room'=>$calendar['meeting_room'],
	...
	echo'<div class="modal-body">
			<form id="edit_fullcalendar">
				  ...
				  <div class="form-group">
					...
					<input type="text" class="form-control" name="booking_by" value="'.$get_data['booking_by'].'">
				  </div>
				  <div class="form-group">
					<label >department</label>
					<input type="text" class="form-control" name="department" value="'.$get_data['department'].'">
				  </div>
				  <div class="form-group">
					<label >meeting_room</label>
					<input type="text" class="form-control" name="meeting_room" value="'.$get_data['meeting_room'].'">
				  </div>
				  <div class="form-group">
